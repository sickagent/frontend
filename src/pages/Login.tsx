...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-surface-0 flex items-center justify-center p-4 noise">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-sick-500/5 rounded-full blur-[100px]" />
      ...
      >
        ...
        <p className="text-center text-sm text-fg-muted mt-6">
          ...
          <Link to="/register" className="text-sick-400 hover:text-sick-300 font-medium">
            Sign up
          </Link>
        </p>
      </motion.div>
